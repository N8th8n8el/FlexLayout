...
var Layout = /** @class */ (function (_super) {
    ...
    /** @hidden @internal */
    Layout.prototype.UNSAFE_componentWillReceiveProps = function (newProps) {
    ...
    Layout.prototype.renderBorder = function (borderSet, borderComponents, tabComponents, splitterComponents) {
        for (var _i = 0, _a = borderSet.getBorders(); _i < _a.length; _i++) {
            var border = _a[_i];
            if (border.isShowing()) {
                borderComponents.push(React.createElement(BorderTabSet_1.BorderTabSet, { key: "border_" + border.getLocation().getName(), border: border, layout: this, iconFactory: this.props.iconFactory, titleFactory: this.props.titleFactory, closeIcon: this.props.closeIcon }));
    ...
    Layout.prototype.renderChildren = function (node, tabSetComponents, tabComponents, splitterComponents) {
        ...
        for (var _i = 0, _a = drawChildren; _i < _a.length; _i++) {
            ...
            if (child instanceof SplitterNode_1.default) {
                ...
                tabSetComponents.push(React.createElement(TabSet_1.TabSet, { key: child.getId(), layout: this, node: child, iconFactory: this.props.iconFactory, titleFactory: this.props.titleFactory, closeIcon: this.props.closeIcon, minimizeIcon: this.props.minimizeIcon, maximizeIcon: this.props.maximizeIcon }));
