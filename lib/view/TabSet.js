...
var TabSet = /** @class */ (function (_super) {
    ...
    TabSet.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
    ...
    TabSet.prototype.render = function () {
            ...
            if (this.props.node.isEnableMaximize()) {
                if (node.isMaximized()) {
                    buttons.push(this.props.minimizeIcon ?
                        React.createElement("div", { key: "min", "aria-label": "Minimize", onClick: this.onMaximizeToggle }, this.props.minimizeIcon)
                        : React.createElement("button", { key: "min", "aria-label": "Minimize", className: cm("flexlayout__tab_toolbar_button-max"), onClick: this.onMaximizeToggle }));
                }
                else {
                    buttons.push(this.props.maximizeIcon ?
                        React.createElement("div", { key: "max", "aria-label": "Maximize", onClick: this.onMaximizeToggle }, this.props.maximizeIcon)
                        : React.createElement("button", { key: "max", "aria-label": "Maximize", className: cm("flexlayout__tab_toolbar_button-min"), onClick: this.onMaximizeToggle }));
                }
            }
        ...
        if (this.showOverflow === true) {
            tabs.push(React.createElement("button", { key: "overflowbutton", ref: function (ref) { return _this.overflowbuttonRef = (ref === null) ? undefined : ref; }, className: cm("flexlayout__tab_button_overflow"), onTouchStart: this.onInterceptMouseDown, onClick: this.onOverflowClick.bind(this, hiddenTabs), onMouseDown: this.onInterceptMouseDown }, hiddenTabs.length));
        }
